...
public class DecodingResult {
    ...
    public DecodingResult(int wordlength, int interleaveHeight, String resultString, String[] words, String[] postInterleaveCodewords, String[] errorCorrectedCodeWords, String receivedData, int errorCount) {
